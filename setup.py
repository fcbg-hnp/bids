...
# Version
version = None
with open(Path(__file__).parent/'hnp_bids'/'_version.py', 'r') as file:
    for line in file:
        line = line.strip()
...
# Descriptions
short_description = """BIDS converter for HNP datasets."""
...
URL = 'https://github.com/fcbg-hnp/bids'
LICENSE = 'MIT License'
DOWNLOAD_URL = 'https://github.com/fcbg-hnp/bids'
VERSION = version
...
setup(
    ...
    project_urls={
        'Documentation': 'https://github.com/fcbg-hnp/bids',
        'Source': 'https://github.com/fcbg-hnp/bids',
        'Tracker': 'https://github.com/fcbg-hnp/bids/issues'
        },
    platforms='any',
    python_requires='>=3.7',
